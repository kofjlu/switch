...
const struct fal_flash_dev stm32_onchip_flash_16k = { "onchip_flash_16k", STM32_FLASH_START_ADRESS_16K, FLASH_SIZE_GRANULARITY_128K, FLASH_SIZE_GRANULARITY_128K, {NULL, fal_flash_read_16k, fal_flash_write_16k, fal_flash_erase_16k} };
const struct fal_flash_dev stm32_onchip_flash_64k = { "onchip_flash_64k", STM32_FLASH_START_ADRESS_64K, FLASH_SIZE_GRANULARITY_256K, FLASH_SIZE_GRANULARITY_256K, {NULL, fal_flash_read_64k, fal_flash_write_64k, fal_flash_erase_64k} };
